      ...
      {focusedTask ? (
        ...
        <main className="space-y-10">
          ...
          <section className="space-y-3">
            ...
            {/* Category Filter row */}
            <div className="flex flex-wrap items-center gap-4 pb-2 border-b border-[#EAEAEA]">
              ...
              {/* Divider between category filters and hide completed toggle */}
              <span className="text-[#EAEAEA] font-mono text-xs hidden sm:inline">|</span>
              ...
              <label className="flex items-center gap-2 text-xs font-mono text-[#787774] hover:text-[#111111] cursor-pointer select-none">
                <input
                  ...
                  className="w-3.5 h-3.5 rounded border border-[#787774]/40 checked:bg-[#111111] text-[#111111] focus:ring-0 focus:ring-offset-0 transition-colors cursor-pointer accent-[#111111]"
                />
